...
public class Service {
    ...
    public void createStudentFile(String idStudent, String idTema, double valNota, int predare, String feedback) {
        Nota nota = new Nota(new Pair(idStudent, idTema), valNota, predare, feedback);
